							...
							echo "<tr $cor>";
								...
								echo "<td class='text-right'>";
									...
									if($this->session->grupo_id == 1 || $this->input->cookie('grupo_id') == 1)
										echo "<a href='".$url."$controller/permissoes/".$fornecedores[$i]['Fornecedor_id']."' title='Permissões' style='color:cursor: 	pointer;' class='glyphicon glyphicon-ok-sign text-danger'></a> | ";
