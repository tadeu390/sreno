				...
				<div class="form d-flex align-items-center">
					<div class="content" id="login">
					  <?php
						...
						?> 
							<img class="mx-auto d-block img-login" src="<?php echo $url;?>/content/imagens/logo.png">	<span class="text-danger" style='font-size: 17px;'>Recuperar senha</span><br /><br />
							...
							<div class="text-left">
								<button type="submit" class="btn btn-danger col-lg-5">Enviar</button>
							</div>
						</form>
					</div>
				</div>
