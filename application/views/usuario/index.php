					...
					echo "<thead>";
						...
						echo"<tr>";
							...
							if(permissao::get_permissao(CREATE, $controller))
								echo"<a class='btn btn-danger' href='".$url."$controller/create/0/'><span class='glyphicon glyphicon-plus'></span> Novo usuário</a>";
							echo"</td>";
						echo"</tr>";
						echo "<tr>";
							echo "<td>#</td>";
							echo "<td>";
								echo"<a id='col-list' href='".$url."$controller/index/".$paginacao['pg_atual']."/Nome/".$paginacao['order']."".$paginacao['filter']."'>Nome</a>";
							...
							echo"</td>";
							echo "<td>";
								echo "<a id='col-list' href='".$url."$controller/index/".$paginacao['pg_atual']."/Ativo/".$paginacao['order']."".$paginacao['filter']."'>Ativo</a>";
